const propiedadesJSON = [
  ...
  let inputMinMetros = document.querySelector("#metrosMinimos")
  let inputMaxMetros = document.querySelector("#metrosMaximos")
  
  botonBuscar.addEventListener("click", function (){
    let cantidadCuartos = inputCantidadCuartos.value;
    let minMetros = inputMinMetros.value;
    let maxMetros = inputMaxMetros.value;

    if (cantidadCuartos == "" || minMetros == "" || maxMetros == "") {
